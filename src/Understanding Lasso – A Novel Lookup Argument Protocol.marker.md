...
| $\mathbf{step}$ | operation                   | $\Delta RS_{\mathrm{step}}$ | $\Delta WS_{\mathrm{step}}$ |
|-----------------|-----------------------------|-----------------------------|-----------------------------|
| 1               | $read(1) \rightarrow (5,0)$ | (1, 5, 0)                   | (1, 5, 1)                   |
| 2               | $read(0) \rightarrow (a,0)$ | (0, a, 0)                   | (0, a, 1)                   |
| 3               | $read(2) \rightarrow (7,0)$ | (2,7,0)                     | (2,7,1)                     |
...
| Сомміт | $\mathcal{O}(c \cdot Commit)$                             |
|--------|-----------------------------------------------------------|
| Prove  | $\mathcal{O}(c \cdot M + c \cdot m + c \cdot Com_{Eval})$ |
| Verify | $\mathcal{O}(c \cdot \log M + c \cdot Com_{Verify})$      |
